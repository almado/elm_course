...
var Elm = {};
Elm['ArchitectedHello'] = Elm['ArchitectedHello'] || {};
if (typeof _user$project$ArchitectedHello$main !== 'undefined') {
    _user$project$ArchitectedHello$main(Elm['ArchitectedHello'], 'ArchitectedHello', undefined);
}
